...
--Products Table
-- No requiere ningun campo de otra relación
...
-- Offices table
-- Falta relacionar MGR con EMPL_NUM.salesreps
...
--Eliminamos filas que pudieran existir en las tablas
